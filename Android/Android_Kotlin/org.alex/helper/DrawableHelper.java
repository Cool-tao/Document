...
import org.alex.helper.library.Shape;
...
@SuppressWarnings({"WrongConstant", "WeakerAccess", "ConstantConditions", "UnnecessaryLocalVariable", "unused", "deprecation"})
public class DrawableHelper {
    ...
    public void bindBitmapDrawable(View imageView, int... resId) {
        Drawable drawable = generateBitmapDrawable(imageView.getContext(), resId);
