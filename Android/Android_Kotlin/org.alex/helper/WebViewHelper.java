...
public class WebViewHelper {
    ...
    private WebViewHelper(WebView webView) {
        this.webView = webView;
        this.webSettings = webView.getSettings();
        initDefaultWebViewSettings();
    }

    public static WebViewHelper getInstance(WebView webView) {
     ...
     * @return
     */
    public WebViewHelper javaScriptEnabled(boolean enabled) {
     ...
     * @return
     */
    public WebViewHelper scrollBarEnabled(boolean enabled) {
     ...
     * @return
     */
    public WebViewHelper setCacheMode(int mode) {
        /*关闭WebView中缓存*/
     ...
     * @return
     */
    public WebViewHelper applyCacheModeByNetWork() {
    ...
    public WebViewHelper clearCache() {
     ...
     * @return
     */
    public WebViewHelper setAppCachePath(String cacheDir) {
