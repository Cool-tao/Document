...
public class StringUtil {
     ...
     * <br/>不匹配, 返回false
     */
    public static boolean isPwdLengthOK(Object text, int min, int max) {
        if (isEmpty(text)) {
            return false;
        }
        String str = text.toString();
    ...
    public static int toInt(Object text, int defaultValue) {
        if (isEmpty(text)) {
            return defaultValue;
        }
        String str = text.toString();
    ...
    public static float toFloat(Object text, int defaultValue) {
        if (isEmpty(text)) {
            return defaultValue;
        }
        String str = text.toString();
     ...
     */
    public static String subString4End(Object text, String split) {
        if (isEmpty(text)) {
            return (text == null ? "" : text.toString());
        }
        String str = text.toString();
     ...
     */
    public static String subString4Start(Object text, String split) {
        if (isEmpty(text)) {
            return (text == null ? "" : text.toString());
        }
        String str = text.toString();
     ...
     * 从 最后一个 split开始，到text结束的字串（不包含split）
     */
    private static String subString4Start2StringEnd(Object text, String split) {
        if (isEmpty(text)) {
            return (text == null ? "" : text.toString());
        }
        String str = text.toString();
     ...
     * 从 最后一个 split开始，到text结束的字串（不包含split）
     */
    private static String subString4Start2End(Object text, String split) {
        if (isEmpty(text)) {
            return (text == null ? "" : text.toString());
        }
        String str = text.toString();
    ...
    public static String trim(Object text, char oldChar) {
        if (isEmpty(text)) {
            return (text == null ? "" : text.toString());
        }
        String str = text.toString();
    ...
    private boolean equalsIgnoreCase(Object a, Object b) {
        return a == null && b == null || a != null && b != null && a.toString().equalsIgnoreCase(b.toString());
    }
     ...
     * @return
     */
    private static String trim(Object text) {
